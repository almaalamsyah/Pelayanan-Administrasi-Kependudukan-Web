            ...
            <div id="content" class="tengah">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h4 class=" mb-0 text-gray-800">Pengajuan Surat</h4>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2 big" style="cursor: pointer;" onclick="window.location='view_data_pengajuan_belum.php';">
                                <div class="card-body">
                                   <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <?php
                                                ...
                                                $all_data = mysqli_query($conn,"SELECT * FROM pengajuan LEFT JOIN pelayanan ON pengajuan.id_pengajuan = pelayanan.id_pengajuan
																							WHERE pelayanan.id_pengajuan IS NULL");
						...
						<div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2 big" style="cursor: pointer;" onclick="window.location='view_data_pengajuan_selesai.php';">
                                <div class="card-body">
                                   <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                            ...
                                            <?php
                                                ...
                                                $all_data_pengunjung = mysqli_query($conn,"SELECT * FROM pelayanan WHERE id_akun='$id'");
