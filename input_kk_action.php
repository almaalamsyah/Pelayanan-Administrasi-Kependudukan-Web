			...
			if ($row > 0 ){
				if ($sel['id_jenis_surat'] == $surat){
					...
					<script>
 					...
 					// Simpan ke Database
					$query = mysqli_query($conn, "INSERT INTO pengajuan (tgl_pengajuan, gambar_ktp, gambar_akta, nik, id_jenis_surat, catatan) VALUES ('$tgl', '$nama2','$nama1', '$nik','$surat','$catatan')");
