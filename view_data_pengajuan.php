            ...
            <div id="content" class="tengah">
                ...
                <div class="container-fluid">
					...
					<div class="card">
						...
						<?php
							require ('koneksi.php');
							$result= mysqli_query($conn, "SELECT * from pelayanan INNER JOIN pengajuan ON pelayanan.id_pengajuan=pengajuan.id_pengajuan INNER JOIN akun ON pelayanan.id_akun=akun.id_akun");
