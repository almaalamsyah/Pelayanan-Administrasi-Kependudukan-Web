<?php
    ...
    <body>
        <div id=halaman>
            ...
            <h3 id=judul><u>SURAT PERMOHONAN KK</u></h3>
            <p id=judul2>Nomor : 145 /           - Desa / 2023</p>
            <br>

            <p  class="para">Yang bertanda tangan di bawah ini, menerangkan Pemohon Pembuatan KK dengan data sebagai berikut :</p>
            ...
            <br>
            <br>
            <p  class="para">Berdasarkan pengamatan Kami, yang bersangkutan benar-benar penduduk yang berdomisili di dusun <?php echo $cetak1['nama_dusun']; ?>, RW <?php echo $cetak1['rw']; ?>, RT <?php echo $cetak1['rt']; ?> 
			Desa Karangpawitan Kecamatan Padaherang, Kabupaten Pangandaran Provinsi Jawa Barat dan terdaftar dalam register kependudukan Kami.</p>

            <p  class="para">Demikian surat permohonana pembuatan KK ini dibuat dengan benar untuk digunakan sebagaimana perlunya.</p>
