<?php
    ...
    $nik = $_GET['nik'];    
	$surat = $_GET['id_surat']; 
    $id = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * from pengajuan WHERE nik='$nik' AND id_jenis_surat='$surat' "));
?>
            ...
            <div id="content">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  <thead>
                    <center>
                        <h5>Pengajuan Belum Disetujui</h5> 
                        <h2>
                        <?php 
							switch ($id['id_jenis_surat']) {
								case 1:
				...
				<center>
					<div class="input_down">
                        <a href="<?php echo "edit_pengajuan.php?nik=".$data['nik']."&id_surat=".$data['id_jenis_surat']; ?>" class="btn btn-primary btn-icon-split">
                            <span class="icon text-white-50">
