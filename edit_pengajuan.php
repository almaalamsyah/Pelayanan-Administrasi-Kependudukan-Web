<?php
    ...
    $nik = $_GET['nik'];    
	$surat = $_GET['id_surat']; 
    $data = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * from pengajuan WHERE nik='$nik' AND id_jenis_surat='$surat' "));
?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content" class="tengah">
                ...
                <div class="container-fluid">
                    ...
                    <form autocomplete="off" required="" enctype="multipart/form-data" method="POST" action="edit_pengajuan_action.php">
                        <div class="card-body">
                            <br>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control input" id="exampleInputTtd" required="" name="catatan" value="<?php echo $data['catatan']; ?>" readonly>
                            </div>
							<div class="form-group">
