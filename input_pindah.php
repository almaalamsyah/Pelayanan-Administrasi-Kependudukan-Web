            ...
            <div id="content">
                ...
                <div class="container-fluid">
					<?php   
                     ...
                     ?>   
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Pengajuan Surat Permohonana Pindah</h1>

                    <form autocomplete="off" required="" enctype="multipart/form-data" method="POST" action="input_pengajuan_action.php?surat=5">
                        <div class="card-body">
                            <br>
