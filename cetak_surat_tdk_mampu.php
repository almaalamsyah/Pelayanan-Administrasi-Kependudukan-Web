<?php
    ...
    <body>
        <div id=halaman>
            ...
            <br>
            <p  class="para">Benar nama yang tercantum diatas adalah warga <?php echo $cetak1['nama_dusun']; ?>, RW <?php echo $cetak1['rw']; ?>, RT <?php echo $cetak1['rt']; ?>  
			Desa Karangpawitan. Dengan sepengetahuan kami dan sesuai data yang ada di kantor Desa orang tersebut diatas benar keluarga kurang mampu <b>
			( KELUARGA BERPENGHASILAN RENDAH )</b> </p>
