        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content" class="tengah">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">View Data Kepala Desa</h1>
                    ...
                    <div class="input_down">
                        <a href="input_kepala_desa.php" class="btn btn-primary btn-icon-split tambah">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered container" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>Nama</th>
                                            <th>TTD</th>
                                    ...
                                    $result= mysqli_query($conn, "SELECT * FROM kepala_desa");
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="zoom"><img src="img/<?php echo  $data['ttd_kepala_desa']; ?>">
                                            </td>
                                            <td>
                                                <center>
                                                    <a href="<?php echo "delete_kepala_desa_action.php?id_kepala_desa=".$data['id_kepala_desa']; ?>" class="btn btn-danger btn-circle btn-sm" data-toggle="tooltip" title="Delete">
