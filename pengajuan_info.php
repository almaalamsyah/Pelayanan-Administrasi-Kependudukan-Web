<?php
    ...
    $id = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * from pengajuan INNER JOIN jenis_surat ON pengajuan.id_jenis_surat=jenis_surat.id_jenis_surat WHERE id_pengajuan='$id_pengajuan'"));
?>
            ...
            <div id="content">
                ...
                <div class="card-body">
                    <div class="input_down">
                        <a href="<?php echo "pengajuan.php"; ?>" class="btn btn-primary btn-icon-split">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                        require ('koneksi.php');
                        $result= mysqli_query($conn, "SELECT * from pengajuan INNER JOIN data_penduduk ON pengajuan.nik=data_penduduk.nik WHERE id_pengajuan='$id_pengajuan'") or die(mysqli_error($conn));
						$data = mysqli_fetch_array($result);
						$result1= mysqli_query($conn, "SELECT * from pelayanan INNER JOIN akun ON pelayanan.id_akun=akun.id_akun WHERE id_pengajuan='$id_pengajuan'") or die(mysqli_error($conn));
				...
				<div class="card-body">
					<center>
					<a href="<?php echo "cetak_surat_action.php?nik=".$data['nik']."&id=".$id['id_jenis_surat']; ?>" class="btn btn-primary btn-icon-split" target="_blank">
						<span class="icon text-white-50">
