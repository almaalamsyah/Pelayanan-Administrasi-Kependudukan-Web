        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content" class="tengah">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">View Data Pengajuan Belum</h1>
                                ...
                                if(isset($_GET['update'])){
                                    ...
                                    if($_GET['acc'] == "success"){
                                        echo "
                                            ...
                                            <div class='alert alert-success alert-dismissible div4'>
                                                <button type='button' class='close' data-dismiss='alert'>&times;</button>
                                                <strong>Data berhasil diacc</strong>
                                            </div>
                                            <center>
                                        ";
                                    }
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    $result= mysqli_query($conn,"SELECT * FROM pengajuan LEFT JOIN pelayanan ON pengajuan.id_pengajuan = pelayanan.id_pengajuan WHERE pelayanan.id_pengajuan IS NULL");
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="download.php?filename=<?=$data['gambar_ktp']?>">KTP</a><br>
                                                <a href="download.php?filename=<?=$data['gambar_kk']?>">KK</a><br>
                                                <a href="download.php?filename=<?=$data['gambar_akta']?>">AKTA</a><br>
                                            </td>
                                            <td>
                                                <center>
                                                    <a href="<?php echo "acc_pengajuan_action.php?nik=".$data['nik']."&id_surat=".$data['id_jenis_surat']; ?>" class="btn btn-success btn-circle btn-sm" data-toggle="tooltip" title="ok">
                                                        <i class="fas fa-spell-check"></i>
                                                    </a>
                                                    <a href="<?php echo "update_pengajuan.php?nik=".$data['nik']."&id_surat=".$data['id_jenis_surat']; ?>" class="btn btn-primary btn-circle btn-sm" data-toggle="tooltip" title="Edit">
                                                        <i class="fas fa-pencil-alt"></i>
                                                    </a>
                                                    <a href="<?php echo "delete_pengajuan_action.php?nik=".$data['nik']."&id_surat=".$data['id_jenis_surat']; ?>" class="btn btn-danger btn-circle btn-sm" data-toggle="tooltip" title="Delete">
