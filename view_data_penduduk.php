<?php
    ...
    $query = mysqli_query($conn, "SELECT * FROM dusun");
            ...
            <div id="content" class="tengah">
                ...
                <div class="container-fluid">
					<div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h4 class=" mb-0 text-gray-800">Data Penduduk</h4>
                    </div>
					<!-- Page Heading -->
					<div class="card">
						<!-- /.card-header -->
						...
						<?php
							require ('koneksi.php');
							$result= mysqli_query($conn, "SELECT * from data_penduduk INNER JOIN dusun ON data_penduduk.id_dusun=dusun.id_dusun");
